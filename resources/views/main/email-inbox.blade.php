@include("partialsLexa/main")
    ...
    <head>
        ...
        @include("partialsLexa/title-meta", ["title" => "Inbox"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partialsLexa/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"Email" ,"title" => "Inbox"])
                                    ...
                                    <div class="card">
                                        ...
                                        <ul class="message-list">
                                            <li class="unread">
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject">Hello &nbsp;–&nbsp; <span
                                                            class="teaser">Trip home from Colombo has been arranged, then
                                            ...
                                            <li>
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject"><span
                                                            class="bg-warning badge me-2">Freelance</span>Since you
                                                        asked... and i'm
                                            ...
                                            <li class="unread">
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject"><span
                                                            class="bg-success badge me-2">Family</span>Last pic over my
                                                        village &nbsp;–&nbsp;
                                            ...
                                            <li>
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject">Mochila Beta: Subscription Confirmed
                                                        &nbsp;–&nbsp; <span class="teaser">You've been confirmed! Welcome to
                                                            the ruling class of the inbox. For your records, here is a copy
                                            ...
                                            <li>
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject"><span
                                                            class="bg-primary badge me-2">Social</span>Task assigned:
                                                        Clone ARP's website
                                                        &nbsp;–&nbsp; <span class="teaser">You have been assigned a task by
                                            ...
                                            <li class="unread">
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject"><span
                                                        ...
                                                        &nbsp;–&nbsp; <span class="teaser">That's just perfect! See you
                                                            tomorrow.</span>
                                                    </a>
                                            ...
                                            <li>
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject">1 new items in your Stackexchange inbox
                                                        &nbsp;–&nbsp; <span class="teaser">The following items were added to
                                            ...
                                            <li>
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject">You can now use your storage in Google
                                                        Drive &nbsp;–&nbsp; <span class="teaser">Hey Nicklas Sandell! Thank
                                            ...
                                            <li>
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject">Train/Bus &nbsp;–&nbsp; <span
                                                            class="teaser">Yes ok, great! I'm not stuck in Stockholm
