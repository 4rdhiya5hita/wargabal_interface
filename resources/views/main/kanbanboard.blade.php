@include("partialsLexa/main")
    ...
    <head>
        ...
        @include("partialsLexa/title-meta", ["title" => "Kanban Board"])
    ...
    @include("partialsLexa/body")

        <!-- Begin page -->
        <div id="layout-wrapper">

            @include("partialsLexa/menu")
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partialsLexa/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"Kanban Board","title" =>"Kanban Board"])
