@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Form Validation"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"Forms", "title" =>"Form Validation"])
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="custom-validation" action="#">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <textarea required class="form-control" placeholder="Type here" rows="5"></textarea>
                                                </div>
                                            </div>
                                            <div class="mb-0">
                                                <div>
