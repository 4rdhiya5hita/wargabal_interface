@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Ion Icons"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"Tables" ,"title" => "Ion Icons"])
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Use <code>&lt;i class="ion-ionic"&gt;&lt;/i&gt;</code>.
                                        </p>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4">IOS</h4>
