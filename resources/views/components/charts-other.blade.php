@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Jquery Knob Chart"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"Charts" ,"title" => "Jquery Knob Chart"])
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row text-center">
                                            <div class="col-xl-4 col-sm-6 text-center" dir="ltr">
