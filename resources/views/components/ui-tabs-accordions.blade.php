@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Tabs & Accordions"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"UI Elements", "title" =>"Tabs & Accordions"])
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">
                                            You can use a link with the <code class="highlighter-rouge">href</code> attribute, or a button with the <code class="highlighter-rouge">data-target</code> attribute. In both cases, the <code class="highlighter-rouge">data-bs-toggle="collapse"</code> is required.
                                        </p>
