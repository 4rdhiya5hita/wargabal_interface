@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Typography"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"UI Elements", "title" =>"Typography"])
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">For quoting blocks of content from another source within your document. Wrap <code class="highlighter-rouge">&lt;blockquote
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Remove a list’s bullets and apply some light <code class="highlighter-rouge">margin</code> with a combination of two classes, <code class="highlighter-rouge">.list-inline</code> and
