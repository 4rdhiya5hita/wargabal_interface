@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Cards"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"UI Elements", "title" =>"Cards"])
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <blockquote class="card-blockquote mb-0">
                                            ...
                                            <footer class="blockquote-footer mt-0 mb-0">
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-img-overlay">
                                        ...
                                        <p class="card-text text-white">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
                                        </p>
                                        <p class="card-text">
                            ...
                            <div class="col-lg-4">
                                <div class="card text-white bg-dark">
                                    <div class="card-body">
                                        <blockquote class="card-blockquote mb-0">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
                                            <footer class="blockquote-footer font-size-12 mt-0 mb-0">
                                                Someone famous in <cite title="Source Title">Source Title</cite>
                                            </footer>
                                        </blockquote>
                                    </div>
