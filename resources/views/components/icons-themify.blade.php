@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Themify Icons"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"Icons" ,"title" => "Themify Icons"])
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4 mt-5">Web App Icons</h4>
                                        <div class="row row icon-demo-content">
                                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                        ...
                                        <h4 class="card-title mt-5 mb-4">Control Icons</h4>
                                        ...
                                        <h4 class="card-title mt-5 mb-4">Text Editor</h4>
                                        ...
                                        <h4 class="card-title mt-5 mb-4">Layout Icons</h4>
                                        ...
                                        <h4 class="card-title mt-5 mb-4">Brand Icons</h4>
