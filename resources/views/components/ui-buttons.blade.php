@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Buttons"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"UI Elements", "title" =>"Buttons"])
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <button type="button" class="btn btn-outline-light text-white waves-effect">Light</button>
                                        </div>
                                    </div>
                                </div><!-- end card -->
                            </div><!-- end col-->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Create block level buttons—those that span the full width of a parent—by adding <code class="highlighter-rouge">.d-grid</code>.</p>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                            ...
                                            <label class="btn btn-secondary" for="btncheck1">Checkbox 1</label>
                                          
                                            <input type="checkbox" class="btn-check" id="btncheck2" autocomplete="off">
                                            <label class="btn btn-secondary" for="btncheck2">Checkbox 2</label>
                                          
                                            <input type="checkbox" class="btn-check" id="btncheck3" autocomplete="off">
                                            <label class="btn btn-secondary" for="btncheck3">Checkbox 3</label>
                                          </div>
