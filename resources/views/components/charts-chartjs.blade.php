@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Chartjs Chart"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"Charts" ,"title" => "Chartjs Chart"])
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <canvas id="lineChart" height="300" data-colors='["--bs-primary-rgb, 0.2", "--bs-primary", "--bs-light-rgb, 0.2", "--bs-light"]'></canvas>
