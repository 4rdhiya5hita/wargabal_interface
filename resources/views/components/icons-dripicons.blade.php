@include("partials/main")
    ...
    <head>
        ...
        @include("partials/title-meta", ["title" => "Dripicons"])
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @include("partials/page-title", ["pagetitle" =>"Lexa", "subtitle" =>"Icons" ,"title" => "Dripicons"])
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Use <code>&lt;i
