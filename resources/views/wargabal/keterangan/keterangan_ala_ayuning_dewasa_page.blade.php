    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                @include("partials/page-title", ["pagetitle" => "Wargabal", "subtitle" => "Keterangan", "title" => "Keterangan Ala Ayuning Dewasa"])
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $value['ala_ayuning_dewasa'] }}</td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body p-4">
                                                <form action="{{ route('edit_ala_ayuning_dewasa', $value['id']) }}" method="POST" class="needs-validation" novalidate>
                                                    @csrf
                                                    <div class="mb-3">
                                                        <label for="nama" class="form-label">Nama</label>
                                                        <input type="text" class="form-control" id="nama" value="{{ $value['ala_ayuning_dewasa'] }}" style="background-color: #f0f0f0;" disabled>
                                                        <input type="hidden" name="nama" value="{{ $value['ala_ayuning_dewasa'] }}">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body p-4">
                                                <form action="{{ route('ajukan_edit', $value['id']) }}" method="POST" class="needs-validation" novalidate>
                                                    ...
                                                    <input type="hidden" name="item_name" value="{{ $value['ala_ayuning_dewasa'] }}">
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                </form>
                                            </div>
                                        </div>
