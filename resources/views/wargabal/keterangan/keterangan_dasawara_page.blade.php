    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                @include("partials/page-title", ["pagetitle" => "Wargabal", "subtitle" => "Keterangan", "title" => "Keterangan Dasawara"])
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body p-4">
                                                <form action="{{ route('edit_dasawara', $value['id']) }}" method="POST" class="needs-validation" novalidate>
                                                    @csrf
                                                    <div class="mb-3">
