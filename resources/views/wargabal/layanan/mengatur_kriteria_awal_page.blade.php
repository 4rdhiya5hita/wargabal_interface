                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('mengatur_kriteria_parameter_page') }}" method="post">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" id="btn-submit" class="btn btn-info btn-soft w-100 mt-4 mb-0">Mengatur Parameter</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script>
    ...
    const optionDewasa = <?php echo json_encode($option_dewasa); ?>;
